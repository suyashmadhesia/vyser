...
class Parser:
    ...
    def match_token(self, kind: SyntaxKind) -> SyntaxToken:
        ...
        self._diagnostics.report_unexpected_token(self.current.span, self.current.kind, kind)
    ...
    def parse_primary_expression(self) -> ExpressionSyntax:
        ...
        elif self.current.kind == SyntaxKind.TrueKeywordToken or self.current.kind == SyntaxKind.FalseKeywordToken or self.current.kind == SyntaxKind.StringToken or self.current.kind == SyntaxKind.NilToken:
