...
class DiagnosticBag:
    ...
    def report_undefined_unary_operator(self, span: TextSpan, operator_text: str, operand_type: str):
        message = f"Unary operator '{operator_text}' is not defined for type {operand_type}."
        self._report(span, message)

    def report_undefined_binary_operator(self, span: TextSpan, operator_text: str, left_type: str, right_type: str):
